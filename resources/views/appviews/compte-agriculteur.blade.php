    ...
    <div class="custom-popup" id="error-popup">
      ...
      <div class="forms-container">
        <div class="signin-signup">
          <form action="{{url('/agriculteurs/login')}}" class="sign-in-form" method="POST">
            @csrf
          ...
          <form action="{{url('/agriculteurs/register')}}" class="sign-up-form" method="POST">
            @csrf
      ...
      <div class="panels-container">
        <div class="panel left-panel">
          <div class="content">
            <h3>Nouveau sur notre Plateforme?</h3>
        ...
        <div class="panel right-panel">
          <div class="content">
            <h3>Membre de notre plateforme?</h3>
