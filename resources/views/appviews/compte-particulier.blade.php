    ...
    <div class="container">
      ...
      <div class="forms-container">
        <div class="signin-signup">
          <form action="{{url('/particuliers/login')}}" class="sign-in-form"method="POST">
            @csrf
          ...
          <form action="{{url('/particuliers/register')}}" class="sign-up-form" method="POST">
            @csrf
      ...
      <div class="panels-container">
        <div class="panel left-panel">
          <div class="content">
            <h3>Nouveau sur MySmartCrops?</h3>
                    <p>Découvrez une nouvelle façon de vivre l'agriculture avec MySmartCrops ! Créez votre compte dès maintenant et accédez à une plateforme complète pour acheter des produits frais, trouver des projets agricoles passionnants en recherche d'investisseurs. 
        ...
        <div class="panel right-panel">
          <div class="content">
            <h3>Membre de MySmartCrops?</h3>
                    <p>Connectez-vous à votre compte MySmartCrops et poursuivez votre aventure agricole ! 
                        ...
                        Rejoignez-nous pour rester informé, échanger des idées et saisir de nouvelles opportunités sur MySmartCrops</p>
